...
const HomeSlideKhac = (props) => {

    const {id_nvh, id_phong} = props;
    ...
    const getSlides = async() => {
        try {
            ...
            setImgs(jsonData);
            console.log('Ảnh nhà văn hóa (Home khác):', id_nvh,jsonData);
        } catch (error) {
  ...
  return (
    <div id={`carouselphong${id_phong}`} class="carousel slide" data-ride="carousel">
   {(imgs.length)?<div class="carousel-inner">         
    ...
    <button
        ...
        type="button"
        data-target={`#carouselphong${id_phong}`}
        data-slide="prev">
